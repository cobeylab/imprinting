...
imprinting is an R package to reconstruct birth year-specific probabilities of imprinting to influenza A. Reconstructions are done following the methods of [(Gostic et al. 2016)](https://doi.org/10.1128/mBio.00204-19).
...
The generated probabilities may be modified, plotted, and used in independent research. Please cite [(Gostic et al. 2016)](https://doi.org/10.1128/mBio.00204-19), and this package (`citation("imprinting")`).
...
* **For 1918-1996**, we calculate annual intensity using the methods of [Gostic et al. 2016](https://doi.org/10.1128/mBio.00204-19). From 1918-1976, intensity scores are informed by Pneumonia and Influenza excess mortaltity estimates [Housworth et al. 1974](https://academic.oup.com/aje/article-abstract/100/1/40/226436), and from 1976-1977, intensity scores are informed by the influenza A test-positive fraction reported in Table 1 of [Thompson et al. JAMA, 2003](https://jamanetwork.com/journals/jama/fullarticle/195750).
